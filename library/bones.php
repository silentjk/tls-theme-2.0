...
function page_navi($before = '', $after = '') {
	...
	echo $before.'<div class="pagination"><ul class="clearfix list-unstyled pagination">'."";
	if ($paged > 1) {
		$first_page_text = "&laquo";
		echo '<li class="prev"><a href="'.get_pagenum_link().'" title="First"><i class="fa fa-arrow-left"></i></a></li>';
	}
		
	$prevposts = get_previous_posts_link('<i class="fa fa-chevron-left"></i>');
	if($prevposts) { echo '<li>' . $prevposts  . '</li>'; }
	else { echo '<li class="disabled"><a href="#"><i class="fa fa-chevron-left"></i></a></li>'; }
	...
	echo '<li class="">';
	next_posts_link('<i class="fa fa-chevron-right"></i>');
	echo '</li>';
	if ($paged < $max_page) {
		$last_page_text = "&raquo;";
		echo '<li class="next"><a href="'.get_pagenum_link($max_page).'" title="Last"><i class="fa fa-arrow-right"></i></a></li>';
	}
	else { echo '<li class="disabled"><a href="#"><i class="fa fa-chevron-right"></i></a></li>'; }
	echo '</ul></div>'.$after."";
}
