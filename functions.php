  ...
  $form = '<form role="search" method="get" id="searchform" action="' . home_url( '/' ) . '" >
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <button type="submit" id="searchsubmit" class="btn btn-default" value="'. esc_attr__('Search','bonestheme') .'"><i class="fa fa-search"></i></button>
              </span>
            </div>
          </form>';
  return $form;
...
if( !function_exists( "theme_js" ) ) {  
  function theme_js(){
    ...
    wp_register_script(  'jquery', 
      get_template_directory_uri() . '/library/js/libs/jquery.js', 
      array('jquery'), 
      '1.10.2' );

    wp_register_script(  'holder', 
      get_template_directory_uri() . '/library/js/libs/holder.js', 
      array('jquery'), 
      '2.0' );
